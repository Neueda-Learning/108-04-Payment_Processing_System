...
/**
 * Aggregated analytics payload for the dashboard charts (GET /stats/dashboard).
 * Each section is pre-grouped server-side so the frontend can render charts directly.
 */
public class DashboardStatsResponse {
    ...
    public DashboardStatsResponse(LocalDate from, LocalDate to,
