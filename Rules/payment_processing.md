...
(RULES - VALIDATION)(Rest normally goes by norms)
...
If/When you have made progress on the core requirements then requirements for further enhancements will be provided. This will include open-ended enhancements whereby you can make use of your particular skills and experience. (TRY TO GET IT DONE EARLY FOR BONUS)

We will continue working on this project into the week where you start looking at Web front ends. (MAKE FRONT END)

For the Front end, you can use the technologies you have learned about in your training. If you wish to use a specific framework or some other technology, please check with your instructor. (CAN GO ABOVE THE TECHNOLOGIES TAUGHT)
...
2. You should use the database technology you have been using in the training for any persistent storage. (MySQL)

3. Make good use of git. Use branching and pull requests if you can.

4. Any documentation about how to use your REST API would be useful. Maybe Swagger/OpenAPI if you have covered it in your training. (KEEP README and other stuff ready)

5. For this training project, you do NOT need to integrate with real payment networks or gateways - simulate the processing internally. (BUT DOES THAT MEAN WE CAN?)
...
5. Decide on the absolute MINIMUM fields for a first working system e.g. the first version of your payment object may just be an id, amount, currency, and status. (KEEP A NORMALISED VERSION OF YOUR SCHEMA)
...
4. Choose the tasks required for a MINIMAL implementation first. (MOST IMPORTANT)
...
## Considerations
(DO THIS AFTER THE MINIMAL BUILD)
### Idempotency
...
Make a class for this and implement all the functions as earlyas possible
1. **Amount Validation**
